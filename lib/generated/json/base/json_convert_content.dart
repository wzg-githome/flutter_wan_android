...
class JsonConvert {
	static final Map<String, JsonConvertFunction> _convertFuncMap = {
		...
		(BasePageEntity).toString(): BasePageEntity.fromJsonConvert,
  ...
  T? asT<T extends Object?>(dynamic value) {
	...
	static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
		...
		if(<BasePageEntity>[] is M){
			return data.map<BasePageEntity>((Map<String, dynamic> e) => BasePageEntity.fromJsonConvert(e)).toList() as M;
		}
		if(<LoginEntity>[] is M){
